    ...
    <el-dialog title="交接" :visible.sync="open" width="600px" append-to-body :destroy-on-close="true">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="交接日期" prop="handoverDate">
          <el-date-picker
              style="width: 100%;"
              v-model="form.handoverDate" value-format="yyyy-MM-dd"
              type="date"
...
// 页面表单的基本数据
import mixinTableData from "@/views/workhandover/mixins/assetAdminmixins.js"
// 数据接口
import {editAll} from "@/api/workhandover/assetAdmin";
