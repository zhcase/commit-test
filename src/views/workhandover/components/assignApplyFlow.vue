...
// 页面表单的基本数据
import mixinTableData from "@/views/workhandover/mixins/assignApplyFlowmixins.js"
// 数据接口
import { editAll} from "@/api/workhandover/assignApplyFlow";

export default {
  name: "assignApplyFlow",
